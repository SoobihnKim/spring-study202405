...
class PersonMapperTest {
    ...
    void saveTest() {
        //given
        Person p = new Person(999, "마바맨", 59);
        //when
    ...
    @Test
    @DisplayName("아이디가 100인 사람의 정보를 수정한다.")
    void updateTest() {
        //given
        Person p = new Person(100, "뉴마바", 300);
        //when
    ...
    @Test
    @DisplayName("아이디로 사람 정보를 개별 조회한다.")
    void findOneTest() {
        //given
        long id = 100;
        //when
        ...
        assertEquals("뉴마바", person.getPersonName());
    }

    @Test
    @DisplayName("사람 수와 이름 리스트를 조회한다.")
    void findNamesTest() {
        //given
