    ...
    replies.forEach(
      ({
        ...
        <div id='replyContent' class='card-body' data-reply-id='${rno}'>
            ...
            <img class='reply-profile' src="${profileImg ? profileImg : "/assets/img/anonymous.jpg"}" alt="profile image">
...
export async function fetchInfScrollReplies(pageNo = 1) {
  ...
  if (pageNo === 1) {
    ...
    loadedReplies = 0; // 댓글 입력, 삭제 시 다시 1페이지 로딩 시 초기값으로 만들어줘야함
    // 댓글 수 렌더링
